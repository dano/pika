...
class Connection(amqp_object.Class):
    ...
    class Start(amqp_object.Method):
        ...
        NAME = b'Connection.Start'

        def __init__(self, version_major=0, version_minor=9, server_properties=None, mechanisms=b'PLAIN', locales='en_US'):
    ...
    class StartOk(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.mechanism = bytes(self.mechanism)
            except UnicodeEncodeError:
                pass
            offset += length
            length = struct.unpack_from('>I', encoded, offset)[0]
    ...
    class Open(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.virtual_host = bytes(self.virtual_host)
            except UnicodeEncodeError:
                pass
            offset += length
            length = struct.unpack_from('B', encoded, offset)[0]
            ...
            try:
                self.capabilities = bytes(self.capabilities)
            except UnicodeEncodeError:
                pass
            offset += length
    ...
    class OpenOk(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.known_hosts = bytes(self.known_hosts)
            except UnicodeEncodeError:
                pass
            offset += length
            return self
    ...
    class Close(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.reply_text = bytes(self.reply_text)
            except UnicodeEncodeError:
                pass
            offset += length
...
class Channel(amqp_object.Class):
    ...
    class Open(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.out_of_band = bytes(self.out_of_band)
            except UnicodeEncodeError:
                pass
            offset += length
            return self
...
class Exchange(amqp_object.Class):
    ...
    class Declare(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.exchange = bytes(self.exchange)
            except UnicodeEncodeError:
                pass
            offset += length
            length = struct.unpack_from('B', encoded, offset)[0]
    ...
    class Bind(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.destination = bytes(self.destination)
            except UnicodeEncodeError:
                pass
            offset += length
            length = struct.unpack_from('B', encoded, offset)[0]
            ...
            try:
                self.routing_key = bytes(self.routing_key)
            except UnicodeEncodeError:
                pass
            offset += length
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
...
class Basic(amqp_object.Class):
    ...
    class Consume(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.consumer_tag = bytes(self.consumer_tag)
            except UnicodeEncodeError:
                pass
            offset += length
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
    ...
    class GetEmpty(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            try:
                self.cluster_id = bytes(self.cluster_id)
            except UnicodeEncodeError:
                pass
            offset += length
            return self
...
class BasicProperties(amqp_object.Properties):
    ...
    def decode(self, encoded, offset=0):
        ...
        if flags & BasicProperties.FLAG_CONTENT_TYPE:
            ...
            try:
                self.content_type = bytes(self.content_type)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
        ...
        if flags & BasicProperties.FLAG_CONTENT_ENCODING:
            ...
            try:
                self.content_encoding = bytes(self.content_encoding)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
        ...
        if flags & BasicProperties.FLAG_CORRELATION_ID:
            ...
            try:
                self.correlation_id = bytes(self.correlation_id)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
        ...
        if flags & BasicProperties.FLAG_REPLY_TO:
            ...
            try:
                self.reply_to = bytes(self.reply_to)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
        ...
        if flags & BasicProperties.FLAG_EXPIRATION:
            ...
            try:
                self.expiration = bytes(self.expiration)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
        ...
        if flags & BasicProperties.FLAG_MESSAGE_ID:
            ...
            try:
                self.message_id = bytes(self.message_id)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
        ...
        if flags & BasicProperties.FLAG_USER_ID:
            ...
            try:
                self.user_id = bytes(self.user_id)
            except UnicodeEncodeError:
                pass
            offset += length
        else:
